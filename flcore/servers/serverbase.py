...
class Server(object):
    ...
    def set_clients(self, clientObj):
        for i, train_slow, send_slow in zip(range(self.num_clients), self.train_slow_clients, self.send_slow_clients):
            train_data = read_client_data(self.dataset, i, self.fold, is_train=True)
            test_data = read_client_data(self.dataset, i, self.fold, is_train=False)
    ...
    def save_global_model(self):
        ...
        for client in self.clients:
            local_model_path = os.path.join(model_path, self.algorithm + f'_Client_{client.id}' + '.pt')
